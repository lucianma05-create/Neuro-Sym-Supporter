...
#             init_kwargs.pop('trust_remote_code')
...
#         print(f"[Tokenizer Load Error] {e}")  # ✅ 打印原始报错内容
...
#     init_kwargs = _get_init_kwargs(model_args)
#     # 删除旧的trust_remote_code，避免冲突
#     init_kwargs.pop('trust_remote_code', None)
#     # 重新添加trust_remote_code=True
#     init_kwargs['trust_remote_code'] = True
#     # 只传init_kwargs，不要单独再传trust_remote_code参数
...
#                 if 'trust_remote_code' in init_kwargs:
#                     init_kwargs.pop('trust_remote_code')
#                 model = load_class.from_pretrained(**init_kwargs, trust_remote_code=True)
